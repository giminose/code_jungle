package com.systex.mt.db2.bureau.service;
...
public class TelnetBase {
	...
	private static final Logger logger = LogManager.getLogger(TelnetBase.class);
	...
	public String receiveEcho() throws IOException {
